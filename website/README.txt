...
b. norm_tweets_per_day.csv - A file containing the average number of vulgar and control tweets and 
							...
							D3's d3.csv function.
c. norm_tweets_per_hour.csv - A file containing the average number of vulgar and control tweets and 
							their ratio for each of the days we collected data. This is loaded using
							D3's d3.csv function.
d. raw_tweet_dstrib_by_day.json - A file containing the raw number of occurrences for each of our search terms
